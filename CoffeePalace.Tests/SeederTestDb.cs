...
public class SeederTestDb
{
    private readonly ApplicationDbContext dbContext;
    private readonly IWebHostEnvironment env;
    
    public SeederTestDb(ApplicationDbContext dbContext, IWebHostEnvironment env)
    {
    ...
    private async Task SeedProduct()
    {
        ...
        if (!await this.dbContext.CoffeeProducts.AnyAsync(p => p.Name == product.Name))
        {
            ...
            var imageName = Path.Combine(Directory.GetCurrentDirectory(), "seed-image.jpeg");
